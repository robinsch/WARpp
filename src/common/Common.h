...
#  if WAR_COMPILER == WAR_COMPILER_INTEL
#    if !defined(BOOST_ASIO_HAS_MOVE)
#      define BOOST_ASIO_HAS_MOVE
#    endif // !defined(BOOST_ASIO_HAS_MOVE)
#  endif // if WAR_COMPILER == WAR_COMPILER_INTEL
#else
#  include <sys/types.h>
#  include <sys/ioctl.h>
...
WAR_COMMON_API extern char const* localeNames[TOTAL_LOCALES];

WAR_COMMON_API LocaleConstant GetLocaleByName(std::string const& name);

#pragma pack(push, 1)

struct WAR_COMMON_API LocalizedString
{
