...
#  ifdef _WIN64
#    define WAR_PLATFORM_STR "Win64"
#  else
#    define WAR_PLATFORM_STR "Win32"
#  endif
#elif WAR_PLATFORM == WAR_PLATFORM_APPLE
#  define WAR_PLATFORM_STR "MacOSX"
#elif WAR_PLATFORM == WAR_PLATFORM_INTEL
#  define WAR_PLATFORM_STR "Intel"
#else // WAR_PLATFORM_UNIX
#  define WAR_PLATFORM_STR "Unix"
#endif

#ifndef WAR_API_USE_DYNAMIC_LINKING
#  define WAR_LINKAGE_TYPE_STR "Static"
#else
#  define WAR_LINKAGE_TYPE_STR "Dynamic"
#endif

char const* GitRevision::GetFullVersion()
{
    return "WARpp rev. " VER_PRODUCTVERSION_STR
        " (" WAR_PLATFORM_STR ", " "" ", " WAR_LINKAGE_TYPE_STR ")";
}
